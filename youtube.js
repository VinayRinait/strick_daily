...
async function checkInfo() {
  ...
  try {
    ...
    let res1 = await fetch(
      `https://api.openweathermap.org/data/2.5/forecast?q=${value}&appid=${key}&cnt=7&units=metric`
    );
...
function Display(obj) {
  ...
  if (obj.weather == "Rain") {
    image.src =
      "https://www.freepnglogos.com/uploads/rain-png/transparent-download-green-cloud-with-rain-clipart-png-23.png";
  } else if (obj.weather == "Clouds") {
    image.src =
      "https://www.freepnglogos.com/uploads/cloud-clipart/clipart-clouds-picture-images-0.png";
  } else if (obj.weather == "Clear") {
    image.src =
      "https://purepng.com/public/uploads/large/purepng.com-sunnaturehotcartoonsummerspringsun-961524676783prlpu.png";
  } else {
    image.src =
      "https://www.pngmart.com/files/12/Sun-And-Cloud-Download-PNG-Image.png";
  }
  ...
  document.getElementById(
    "gmap_canvas"
  ).src = `https://maps.google.com/maps?q=${obj.name}&t=&z=13&ie=UTF8&iwloc=&output=embed`;

  document
    .getElementById("info")
    .append(name, image, temp, min, max, humdty, sunrise, sunset);
}
